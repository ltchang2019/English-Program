...
<nav class="w3-sidebar w3-blue w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="https://www.google.com" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Group 1</a> 
...
<!-- <body onLoad="newProb();" id="NewProblem">
 --><noscript>Please enable Javascript.</noscript>
    <div id="Page">
    <div id="LeftCol">
  <fieldset id="ProblemArea"> Solve:
            <div id="Container">
                <div id="Answer"><span id="MathField"> </span></div>
                <div id="Directions" style="font-size:30px; text-align: left;"></div>
                <div> <span id="Problem"></span></div>
                <div><span id="MathField"></span></div>
...
var ExpSum;
function newProb(){
        Direction.innerHTML = "Determine the value of:";
  }
