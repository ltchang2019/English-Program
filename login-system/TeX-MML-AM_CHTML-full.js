...
MathJax.Hub.Register.LoadHook("[MathJax]/jax/element/mml/jax.js", function() {
    ...
    a.math.Augment({
        toMathML: function(d, e) {
            ...
            if (g) {
                ...
                j.push(d + '    <annotation encoding="' + this.toMathMLquote(g) + '">' + l + "</annotation>");
                j.push(d + "  </semantics>")
            }
            return d + "<" + p + k + ">\n" + j.join("\n") + "\n" + d + "</" + p + ">"
        }
    ...
    a.entity.Augment({
        toMathML: function(d) {
            return (d || "") + "&" + this.toMathMLquote(this.data[0]) + ";<!-- " + this.toString() + " -->"
        }
    });
    a.xml.Augment({
        toMathML: function(d) {
        ...
        GetDelimiter: function(m, n) {
            ...
            if (this.i <= this.string.length) {
                if (o == "\\") {
                    ...
                    if (o === "{" && n) {
                        this.i--;
                        o = this.GetArgument(m).replace(/^\s+/, "").replace(/\s+$/, "")
                    }
                }
...
(function(aa) {
    ...
    function p(ad, ae) {
        var ab;
        if (ad.charAt(ae) == "\\" && ad.charAt(ae + 1) != "\\" && ad.charAt(ae + 1) != " ") {
            ab = ad.slice(ae + 1)
        } else {
            ab = ad.slice(ae)
        }
    ...
    function R(ac) {
        ...
        if (ac.firstChild.hasChildNodes() && (ac.nodeName == "mrow" || ac.nodeName == "M:MROW")) {
            ab = ac.firstChild.firstChild.nodeValue;
            if (ab == "(" || ab == "[" || ab == "{") {
                ac.removeChild(ac.firstChild)
            }
        }
        if (ac.lastChild.hasChildNodes() && (ac.nodeName == "mrow" || ac.nodeName == "M:MROW")) {
    ...
    function G(ai) {
        ...
        case A:
            ...
            if (typeof ad.func == "boolean" && ad.func) {
                ak = ai.charAt(0);
                if (ak == "^" || ak == "_" || ak == "/" || ak == "|" || ak == "," || (ad.input.length == 1 && ad.input.match(/\w/) && ak != "(")) {
                    return [O(ad.tag, e.createTextNode(ad.output)), ai]
                } else {
                ...
                if (typeof ad.rewriteleftright != "undefined") {
                    ...
                    if (ad.input == "cancel") {
                        ...
                        if (typeof ad.acc == "boolean" && ad.acc) {
                            ...
                            if (ad.input == "vec" && ((al[0].nodeName == "mrow" && al[0].childNodes.length == 1 && al[0].firstChild.firstChild.nodeValue !== null && al[0].firstChild.firstChild.nodeValue.length == 1) || (al[0].firstChild.nodeValue !== null && al[0].firstChild.nodeValue.length == 1))) {
                            ...
                            if (!l && typeof ad.codes != "undefined") {
                                for (af = 0; af < al[0].childNodes.length; af++) {
                                    if (al[0].childNodes[af].nodeName == "mi" || al[0].nodeName == "mi") {
                                        ak = (al[0].nodeName == "mi" ? al[0].firstChild.nodeValue : al[0].childNodes[af].firstChild.nodeValue);
                                        var aj = [];
                                        for (var ae = 0; ae < ak.length; ae++) {
                                            if (ak.charCodeAt(ae) > 64 && ak.charCodeAt(ae) < 91) {
                                                aj = aj + ad.codes[ak.charCodeAt(ae) - 65]
                                            } else {
                                                if (ak.charCodeAt(ae) > 96 && ak.charCodeAt(ae) < 123) {
                                        ...
                                        if (al[0].nodeName == "mi") {
                                            ...
                                            al[0].replaceChild(O("mo").appendChild(e.createTextNode(aj)), al[0].childNodes[af])
                                        }
                                    }
                                }
                            }
                ...
                if (av == ")" || av == "]") {
                    ...
                    if (ac == "(" && av == ")" && ao.output != "}" || ac == "[" && av == "]") {
                        ...
                        for (ar = 0; ap && ar < am; ar = ar + 2) {
                            ...
                            al = ah.childNodes[ar];
                            if (ap) {
                                ap = al.nodeName == "mrow" && (ar == am - 1 || al.nextSibling.nodeName == "mo" && al.nextSibling.firstChild.nodeValue == ",") && al.firstChild.firstChild.nodeValue == ac && al.lastChild.firstChild.nodeValue == av
                            }
                            if (ap) {
                            ...
                            for (ar = 0; ar < am; ar = ar + 2) {
                                ...
                                for (aq = 1; aq < ai - 1; aq++) {
                                    if (typeof ad[ar][an] != "undefined" && aq == ad[ar][an]) {
                                        al.removeChild(al.firstChild);
                                        if (al.firstChild.nodeName == "mrow" && al.firstChild.childNodes.length == 1 && al.firstChild.firstChild.firstChild.nodeValue == "\u2223") {
                                            if (ar == 0) {
                                                af.push("solid")
                                            }
                                            al.removeChild(al.firstChild);
...
(function(o, f, m, a) {
    ...
    a.Augment({
        ...
        fontLoaded: function(s) {
            ...
            MathJax.Callback.Queue(["Post", f.Startup.signal, "CommonHTML - font data loaded for " + s], ["loadComplete", o, this.fontDir + "/" + s])
        },
    ...
    MathJax.Hub.Register.StartupHook("mml Jax Ready", function() {
        ...
        d.mbase.Augment({
            ...
            CHTMLgetVariant: function() {
                var s = this.getValues("mathvariant", "fontfamily", "fontweight", "fontstyle"),
                    u;
            ...
            CHTMLautoload: function() {
                this.constructor.Augment({
                    toCommonHTML: d.mbase.CHTMLautoloadFail
                });
